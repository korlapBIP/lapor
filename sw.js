const CACHE_NAME = 'absensi-bip-v175_email_notifikasi_admin';
const APP_ASSETS=['./','./index.html','./manifest.json','./firebase-config.js','./firebase-bridge.js','./kode_apps_script_email_notifikasi.gs','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-master-transparent.png'];
